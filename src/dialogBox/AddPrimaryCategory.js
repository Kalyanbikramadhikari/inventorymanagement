...
const AddPrimaryCategory = ({ setOpenAddProductDialog }) => {
    const [isVisible, setIsVisible] = useState(false);
    const [openSecondaryCategory, setOpenSecondaryCategory] = useState(false)
    const secondaryCategoryRef = useRef(null);

    const handleOpenSecondaryCategory = () => {
        setOpenSecondaryCategory(true)

        setTimeout(() => {
            secondaryCategoryRef.current?.scrollIntoView({
                behavior: 'smooth',
                block: 'center',
            });
        }, 100);
                ...
                <div className={`bg-white rounded-[5px]  w-2/6 ${isVisible ? 'translate-x-0' : 'translate-x-full'}  relative  transition-transform duration-200 `} onClick={(event) => event.stopPropagation()} >
                    <div className="h-[90vh] overflow-auto pb-20">
                        ...
                        <div className="flex justify-between items-center p-4 border-b">
                            <h2 className="text-xl font-semibold">Add Primary Category</h2>
                            <button
                                onClick={handleClose}
                        ...
                        <div className="p-4">
                            ...
                            <div className="">
                                <h3 className="text-subHeading font-bold mb-4 text-dialog-black p-[17px] border-l-4 border-primary bg-background flex  ">Primary Category</h3>
                                <div className="space-y-4">
                                    <div className='flex flex-col gap-[2px]'>
                                        <label className=" mb-1 flex text-subHeading text-dialog-black">Brand Name</label>
                                        <input
                                            type="text"
                                            name="brandName"
                                    ...
                                    <div className='flex flex-col gap-[2px]'>
                                        <label className=" mb-1 flex text-subHeading text-dialog-black">Brand Code</label>
                                        <input
                                            type="text"
                                            name="brandCode"
                            ...
                            <div className='mt-[40px]'>
                                <h3 className="text-subHeading font-bold mb-4 text-dialog-black p-[17px] border-l-4 border-primary bg-background flex  ">Secondary Category</h3>

                                <button
                                    type="submit"
                                    ref={secondaryCategoryRef}
                                    onClick={handleOpenSecondaryCategory}
