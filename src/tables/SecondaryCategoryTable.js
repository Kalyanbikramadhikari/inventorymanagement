...
const SecondaryCategoryTable = () => {
    const rows = [
        { brand: 'Samsung', brandCode: 'GLX-5487154', status: "ON" },
        { brand: 'Samsung', brandCode: 'GLX-5487154', status: "ON" },
        { brand: 'Samsung', brandCode: 'GLX-5487154', status: "ON" },
        { brand: 'Samsung', brandCode: 'GLX-5487154', status: "ON" },
        { brand: 'Samsung', brandCode: 'GLX-5487154', status: "ON" },
            ...
            <Table>
                <TableHead style={{ background: '#F9FAFB', padding: '5px', paddingLeft: '30px' }}>
                    <TableRow>
                        ...
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Model/Series Name</TableCell>
...
export default SecondaryCategoryTable