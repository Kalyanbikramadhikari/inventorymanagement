...
const CustomersTable = ({ setOpenVendorPreviewDialog, setUserClickedVendorId }) => {
    return (
            ...
            <Table sx={{ padding: '10px' }}>
                <TableHead style={{ background: '#F9FAFB', padding: '5px', paddingLeft: '30px' }}>
                    <TableRow sx={{ marginLeft: '10px' }}>
                        ...
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Customer Name</TableCell>
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Email</TableCell>
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Phone Number</TableCell>
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Total Purchase Amount</TableCell>
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Payment Method</TableCell>
                        <TableCell sx={{ color: '#7A8299', fontFamily: 'Roboto, sans-serif', fontSize: '16px', padding: '15px', }}>Date of creation</TableCell>
